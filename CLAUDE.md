...
- The dashboard's System Prompt textarea is the source of truth (see [dashboard/components/CallDispatcher.tsx](dashboard/components/CallDispatcher.tsx)). Keep dashboard prompts under ~300 tokens. Encourage users with placeholder hints.
